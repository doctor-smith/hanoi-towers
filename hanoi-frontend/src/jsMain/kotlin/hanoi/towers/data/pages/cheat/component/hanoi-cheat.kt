 ...
 */
@ReadWrite val hanoi: Lens<HanoiCheat, Hanoi> by lazy {
    Lens(
 ...
 */
@ReadOnly val texts: Lens<HanoiCheat, Lang> by lazy {
    Lens(
 ...
 */
@ReadOnly val maxNumberOfSlices: Lens<HanoiCheat, Int> by lazy {
    Lens(
