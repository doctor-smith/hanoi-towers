 ...
 */
@ReadWrite val hanoi: Lens<HanoiGame, Hanoi> by lazy {
    Lens(
 ...
 */
@ReadOnly val texts: Lens<HanoiGame, Lang> by lazy {
    Lens(
 ...
 */
@ReadOnly val maxNumberOfSlices: Lens<HanoiGame, Int> by lazy {
    Lens(
