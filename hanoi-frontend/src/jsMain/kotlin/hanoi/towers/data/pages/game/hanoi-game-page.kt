 ...
 */
@ReadOnly val texts: Lens<HanoiGamePage, Lang.Block> by lazy {
    Lens(
 ...
 */
@ReadWrite val game: Lens<HanoiGamePage, HanoiGame> by lazy {
    Lens(
 ...
 */
@ReadWrite val numberOfSlices: Lens<HanoiGamePage, Int> by lazy {
    Lens(
 ...
 */
@ReadWrite val numberOfMoves: Lens<HanoiGamePage, Int> by lazy {
    Lens(
 ...
 */
@ReadWrite val moves: Lens<HanoiGamePage, Moves> by lazy {
    Lens(
 ...
 */
@ReadWrite val isComputingMoves: Lens<HanoiGamePage, Boolean> by lazy {
    Lens(
 ...
 */
@ReadWrite val indexOfCurrentMove: Lens<HanoiGamePage, Int> by lazy {
    Lens(
 ...
 */
@ReadWrite val error: Lens<HanoiGamePage, String?> by lazy {
    Lens(
